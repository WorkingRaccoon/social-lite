...
<template>
  <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
    ...
    <div class="max-w-2xl mx-auto px-4 py-6">
      ...
      <div v-if="post" class="bg-white dark:bg-gray-800 dark:border-gray-700 border border-gray-200 rounded-2xl p-6 mb-6 shadow-sm">
        <div class="flex justify-between items-start mb-4">
          <div class="flex items-center gap-3 mb-1">
            ...
            <div
                v-else
                class="w-10 h-10 rounded-full bg-gray-300 dark:bg-gray-600 flex items-center justify-center text-gray-500 font-bold"
            >
        ...
        />
        <p class="text-gray-700 dark:text-gray-300 leading-relaxed" style="word-break: break-all; overflow-wrap: break-word;">{{ post.content }}</p>
      </div>
      ...
      <!-- 留言區 -->
      <div class="bg-white dark:bg-gray-800 dark:border-gray-700 border border-gray-200 rounded-2xl p-6 mb-6 shadow-sm overflow-hidden">
        ...
        <!-- 分隔線 -->
        <div class="h-px bg-gray-300 dark:bg-gray-100 mb-4"></div>
        ...
        <div class="flex flex-col gap-3">
          ...
          >
            ...
            <p class="text-gray-700 dark:text-gray-300 leading-relaxed" style="word-break: break-all; overflow-wrap: break-word;">{{ comment.content }}</p>
